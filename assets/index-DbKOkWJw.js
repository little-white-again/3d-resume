	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
            ...
            <div class="skill-mini-grid">
              ${t.items.map(n=>`
                <div class="skill-mini">
                  <span class="skill-mini-name">${n.name}</span>
                  <span class="skill-mini-bar"><i style="width:${n.desc}"></i></span>
                </div>
              `).join("")}
            </div>
          </div>
        ...
        <div class="modal-section">
          ...
          <div class="modal-section-body">
            ${t.items.map(n=>`
              <div class="mini-item">
                <span class="mini-item-name">${n.name}</span>
                ${n.desc?`<span class="mini-item-desc">· ${n.desc}</span>`:""}
                ${n.time?`<span class="mini-item-time">${n.time}</span>`:""}
              </div>
            `).join("")}
          </div>
        </div>
